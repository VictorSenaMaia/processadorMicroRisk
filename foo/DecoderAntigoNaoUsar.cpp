...
void formato1(bitset<16> Analise){
    ...
    switch(OP){
        case 0x0000: {
            zeros((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong();
            break;
        }
        case 0x0001:{
            ones((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            break;
        }
        case 0x0002:{
        ...
        case 0x0008:{
            passnota((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            break;
        }
        case 0x0009:{
            passa((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            break;
        }
        case 0x000A:{
        ...
        case 0x0010:{
            //lsl((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "lsl" << endl;
            break;
        }
        case 0x0011:{
            //asl((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "asl" << endl;
            break;
        }
        case 0x0012:{
            //lsr((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "lsr" << endl;
            break;
        }
        case 0x0013:{
            //asr((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "asr" << endl;
            break;
        }
        case 0x0014:{
        ...
        case 0x0016:{
            //store((unsigned short int)Rt.to_ulong(), (unsigned short int),Rb.to_ulong());
            cout << "store" << endl;
            break;
        }
        case 0x0018:{
        ...
        case 0x001c:{
            //inca((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "inca" << endl;
            break;
        }
        case 0x001d: {
            //deca((unsigned short int)Rt.to_ulong(), (unsigned short int)Ra.to_ulong(), (unsigned short int)Rb.to_ulong());
            cout << "deca" << endl;
            break;
        }
    }
...
void formato2(bitset<16> Analise){
    ...
    //loadlit((unsigned short int)Rc.to_ulong(), Offset);
    cout << "loadlit" << endl;
...
void formato3(bitset<16> Analise){
    ...
    if(Analise[10]==0){
        //lcl((unsigned short int)Rc.to_ulong(), Offset);
        cout << "lcl" << endl;
    } else {
        //lch((unsigned short int)Rc.to_ulong(), Offset);
        cout << "lch" << endl;
    }
}
...
void formato4(bitset<16> Analise){
    if(Analise[13]==1 && Analise[12]==1){
        ...
        if(Analise[12]==0){
            //jf((unsigned short int)Cond.to_ulong(), Offset);
            cout << "jf" << endl;
        } else {
            //jt((unsigned short int)Cond.to_ulong(), Offset);
            cout << "jt" << endl;
        }
    }
}
